...
python retdec-decompiler.py --keep-unreachable-funcs --stop-after bin2llvmir -o /mnt/work/project/OSCAR/data-raw/bindiff/gnutls-3.5.19/O0-gcc7.5.0-amd64/libgnutls.so /mnt/work/project/OSCAR/process-bindiff-data/data/gnutls/stripped/O0-gcc7.5.0-amd64/libgnutls.so