...
SRC_DIR = Path("data-raw/clcdsa_clone/preprocessed")
DST_DIR = Path("data-raw/clcdsa_clone/irs")
...
#/mnt/wanyao/guiyi/opt/llvm-6.0/bin/clang -emit-llvm -S -xc++ -std=c++11 -Wno-everything data-raw/poj-binary_code-clone/ProgramData/92/1007.txt -o data-raw/poj-binary_code-clone/irs/92/1007.txt.ll 
